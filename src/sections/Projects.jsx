...
export const Projects = () =>
{
  ...
  <div className="container mx-auto px-6 relative z-10">
      {/* Section Headers*/}
      <div className="text-center mx-auto max-w-3xl mb-16 row-span-5">
        <span className="text-secondary-foreground text-sm font-medium mt-5 tracking-wider uppercase animate-fade-in">Featured Work</span>
