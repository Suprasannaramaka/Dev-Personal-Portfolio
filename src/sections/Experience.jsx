          ...
          <div className="relative">
            ...
            <div className="space-y-10 md:space-y-10 md:flex-col">
              {Experiences.map((exp, idx) => (
                <div
                  key={idx}
                  className="relative grid grid-cols-3 lg:grid-cols-1 gap-5 animate-fade-in"
          ...
          <div className="relative">
            ...
            <div className="space-y-10 flex flex-col">
              {Courses.map((course, idx) => (
                <div key={idx} className="relative grid grid-cols-1 lg:grid-cols-2 gap-5">
                  {/* Timeline Dot */}
                  <div className="absolute left-0 md:left-1/2 top-0  bg-primary rounded-full -translate-x-1/2 ring-4 ring-background z-10" />
