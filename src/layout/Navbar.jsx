...
export const Navbar = () =>
{
    ...
    return(
   <header className={`fixed top-0 left-0 right-0 ${isScrolled ? "glass-strong py-3" : "bg-transparent py-5"} py-5 z-50`}>
    <nav className="container mx-auto px-6 md:flex items-center justify-between">
      ...
      <div className="flex items-center p-5">
        <div className="glass rounded-full px-2 py-1 items-center gap-10 hidden:md:flex">
            ...
            classNmae="px-4 py-2 text-sm text-muted-foreground hover:text-foreground rounded-full hover:bg-surface gap-10">
                {link.label}
            </a>
            ))}
        </div>
